...
CREATE TABLE IF NOT EXISTS `SA`.`TBL_course` (
  ...
  INDEX `member_course_fk_idx` (`member_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `SA`.`TBL_course_registration_record` (
  ...
  INDEX `member_course_registratino_record_fk_idx` (`member_id` ASC) VISIBLE,
  INDEX `course_id_course_registration_record_FK_idx` (`course_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `SA`.`TBL_paid_record` (
  ...
  INDEX `member_paid_record_fk_idx` (`member_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `SA`.`TBL_course_value` (
  ...
  INDEX `course_course_value_fk_idx` (`course_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `SA`.`TBL_borrow_record` (
  ...
  INDEX `member_borrow_record_fk_idx` (`member_id` ASC) VISIBLE,
  INDEX `borrow_record_instrument_fk_idx` (`instrument_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `SA`.`TBL_use_time`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `SA`.`TBL_use_time` ;

CREATE TABLE IF NOT EXISTS `SA`.`TBL_use_time` (
  `instrument_id` INT NOT NULL AUTO_INCREMENT,
  `member_id` INT NOT NULL,
  `use_time` DATETIME NOT NULL,
  PRIMARY KEY (`instrument_id`, `member_id`),
  INDEX `member_use_time_fk_idx` (`member_id` ASC) VISIBLE,
  CONSTRAINT `member_use_time_fk`
    FOREIGN KEY (`member_id`)
    REFERENCES `SA`.`TBL_member` (`member_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `SA`.`TBL_article` (
  ...
  INDEX `member_article_fk_idx` (`member_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `SA`.`TBL_message` (
  ...
  INDEX `member_message_fk_idx` (`member_id` ASC) VISIBLE,
  INDEX `article_message_fk_idx` (`article_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `SA`.`TBL_homework` (
  ...
  INDEX `member_homework_fk_idx` (`member_id` ASC) VISIBLE,
  INDEX `member_course_fk_idx` (`course_id` ASC) VISIBLE,
  CONSTRAINT `member_homework_fk`
    FOREIGN KEY (`member_id`)
    REFERENCES `SA`.`TBL_member` (`member_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `SA`.`TBL_announcement` (
  ...
  INDEX `member_announcement_fk_idx` (`member_id` ASC) VISIBLE,
